...
const findGrape2 = function (arr) {
    for (i = 0; i < arr.length; i++) {
        if(arr[i].color === "purple") {
            return console.log(`The fruit with index ${arr.indexOf(arr[1])} is a grape`)
        }
    }
}
...
// CODE HERE
whatAreMyParameters = (para1, para2) => console.log(`The first parameter is ${para1}. The second parameter is ${para2}`)

// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
whatAreMyParameters(5, 6)
...
greeting(`Kevin`, `Judd`, fullName => console.log("Hello, my full name is " + fullName))
...
// CODE HERE
pricesPlusTax(prices, totalCost => console.log("The new array pluse tax = " + totalCost))
